/* ****************************************
* Square wave output through OC2
...
uint16_t Period = USG_2_TICKS(5000);  //the period timer ticks duration
...
int main () {
  ...
  serial_print("\r\n Period usg: ");
  serial_printdecword(Period/USG_2_TICKS(1));
  ...
  _IO_PORTS_W(M6812_TC2) = _IO_PORTS_W(M6812_TCNT) + Period;
